...
///
/// Source: lib/localization
/// To regenerate, run: `dart run slang`
///
/// Locales: 2
/// Strings: 0 (0 per locale)
///
/// Built on 2025-05-15 at 13:35 UTC
...
enum AppLocale with BaseAppLocale<AppLocale, Translations> {
  ...
  Future<Translations> build({Map<String, Node>? overrides, PluralResolver? cardinalResolver, PluralResolver? ordinalResolver}) async {
    switch (this) {
      case AppLocale.zhCn:
        return TranslationsZhCn(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
      case AppLocale.en:
        await l_en.loadLibrary();
        return l_en.TranslationsEn(overrides: overrides, cardinalResolver: cardinalResolver, ordinalResolver: ordinalResolver);
    }
  }
...
class AppLocaleUtils extends BaseAppLocaleUtils<AppLocale, Translations> {
  AppLocaleUtils._() : super(baseLocale: AppLocale.zhCn, locales: AppLocale.values);
