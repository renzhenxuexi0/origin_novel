...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  @protected
  RuleType dco_decode_box_autoadd_rule_type(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return dco_decode_rule_type(raw);
  }
  ...
  @protected
  RuleType? dco_decode_opt_box_autoadd_rule_type(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_box_autoadd_rule_type(raw);
  }
  ...
  RuleBookInfo dco_decode_rule_book_info(dynamic raw) {
    ...
    return RuleBookInfo(
      ...
      ruleType: dco_decode_opt_box_autoadd_rule_type(arr[11]),
    );
  }
  ...
  RuleContent dco_decode_rule_content(dynamic raw) {
    ...
    return RuleContent(
      ...
      ruleType: dco_decode_opt_box_autoadd_rule_type(arr[8]),
    );
  }
  ...
  RuleExplore dco_decode_rule_explore(dynamic raw) {
    ...
    return RuleExplore(
      ...
      ruleType: dco_decode_opt_box_autoadd_rule_type(arr[9]),
    );
  }
  ...
  RuleReview dco_decode_rule_review(dynamic raw) {
    ...
    return RuleReview(
      ...
      ruleType: dco_decode_opt_box_autoadd_rule_type(arr[10]),
    );
  }
  ...
  @protected
  RuleType sse_decode_box_autoadd_rule_type(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return (sse_decode_rule_type(deserializer));
  }
  ...
  @protected
  RuleType? sse_decode_opt_box_autoadd_rule_type(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_box_autoadd_rule_type(deserializer));
    } else {
      return null;
    }
  }
  ...
  RuleBookInfo sse_decode_rule_book_info(SseDeserializer deserializer) {
    ...
    var var_ruleType = sse_decode_opt_box_autoadd_rule_type(deserializer);
    return RuleBookInfo(
        author: var_author,
  ...
  @protected
  void sse_encode_box_autoadd_rule_type(
      RuleType self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_rule_type(self, serializer);
  }
  ...
  @protected
  void sse_encode_opt_box_autoadd_rule_type(
      RuleType? self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_box_autoadd_rule_type(self, serializer);
    }
  }
  ...
  void sse_encode_rule_book_info(RuleBookInfo self, SseSerializer serializer) {
    ...
    sse_encode_opt_box_autoadd_rule_type(self.ruleType, serializer);
  }
