...
class ($capitalized_feature_name)RemoteDataSource implements I($capitalized_feature_name)RemoteDataSource {
  ...
  @override
  Future<List<($capitalized_feature_name)Dto>> getAll\(\) async {
  // TODO: Implement the API call to fetch all ($capitalized_feature_name)s
  throw UnimplementedError\('getAll\(\) not implemented'\);
  }
  
  @override
  Future<($capitalized_feature_name)Dto> getById\(int id\) async {
  // TODO: Implement the API call to fetch ($capitalized_feature_name) by ID
  throw UnimplementedError\('getById\(\) not implemented'\);
  }
  
  @override
  Future<($capitalized_feature_name)Dto> create\(($capitalized_feature_name)Dto dto\) async {
  // TODO: Implement the API call to create ($capitalized_feature_name)
  throw UnimplementedError\('create\(\) not implemented'\);
  }
  
  @override
  Future<($capitalized_feature_name)Dto> update\(($capitalized_feature_name)Dto dto\) async {
