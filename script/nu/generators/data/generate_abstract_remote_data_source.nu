...
abstract interface class I($capitalized_feature_name)RemoteDataSource {
  ...
  Future<($capitalized_feature_name)Dto> get($capitalized_feature_name)\(\);
  
  /// 创建新的($capitalized_feature_name)
  Future<($capitalized_feature_name)Dto> create($capitalized_feature_name)\(($capitalized_feature_name)Dto dto\);
  
  /// 更新($capitalized_feature_name)
  Future<($capitalized_feature_name)Dto> update($capitalized_feature_name)\(($capitalized_feature_name)Dto dto\);
